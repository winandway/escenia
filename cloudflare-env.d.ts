...
// Runtime types generated with workerd@1.20260925.1 2026-07-01 global_fetch_strictly_public,nodejs_compat
...
type ExportedHandlerTailStreamHandler<Env = unknown, Props = unknown> = (
  ...
  env: Env,
  ctx: ExecutionContext<Props>,
) => TailStream.TailEventHandlerType | undefined | Promise<TailStream.TailEventHandlerType | undefined>;
